...
alex_table = Data.Array.listArray (0 :: Int, 605)
  [ 0
  , 15
  , 15
  , 15
...
alex_check = Data.Array.listArray (0 :: Int, 605)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_1 = \s -> "left branch"
alex_action_2 = \s -> "right branch"
alex_action_3 = \s -> "id: " <> (drop (length "id=\"") (take (length s - 1) s))
alex_action_4 = \s -> "content: " <> (drop (length "content=\"") (take (length s - 1) s))
